...
<div class="node-bulletin dge-detail--bulletin dge-detail--newsletter dge-newsletter-template">
  ...
  <div class="newsletter-content-area sent-newsletter">
      ...
      <?php else: ?>
        <?php
          ...
          if (isset($newsletter->field_bulletin_date['und'][0]['value'])) {
            ...
            $bulletin_date = '<abbr title="'.$bull_month.'">'.substr($bull_month, 0, 3)."</abbr> '".$bull_year;
          }
        ?>
                ...
                <div class="field field-name-field-bulletin-parag-link field-type-link-field">
                  <div class="field-item"><?php
                    $link = array(
                      ...
                      '#options' => array(
                        'attributes' => array('class' => array('cool-class'), 'id' => 'cool-id-' . $count),
                        'html' => FALSE,
                    ));?><?php print render($link); $count++; ?>
                  </div>
                </div>
              <?php endif ?>
            </div>
    ...
    <img style="display: block;margin: 0px auto;height:61px;"alt="Gobierno de España. Ministerio de Hacienda y Administraciones Públicas. Ministerio de Industria y Energía.Red.es.Aporta" src="/sites/all/themes/dge_theme/images/newsletter/dge-nws-institutional-logos.png" />
