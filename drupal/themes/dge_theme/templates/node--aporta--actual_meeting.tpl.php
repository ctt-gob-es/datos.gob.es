        ...
        <div class="elementosAporta">
                    ...
                    <div class="datosAportaPrincipal">
                        <div class="datosAporta">
                            <div class="subDatosAporta">
                                <div id="dateaporta">
                                    <img alt="<?php print t("icono calendario") ?>" class="iconocalendario" src="/sites/all/themes/dge_theme/images/svg/calendar.svg"><?php print (str_replace('-',' de ',$content['field_aporta_date'][0]['#markup']));?>
                                </div>
                                <div id="location" class="finalizado">
                                    <span class="encuentroAporta_viejo"><?php print t('Past event'); ?> </span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="aporta-right-content">
                ...
                <div id="botonAportaInfo">
                    <a class="encuentroAporta" href="<?php print $node_url; ?>"><?php print t('Ver información sobre el evento'); ?> </a>
                </div>
            </div>
        </div>
    </div>
