  ...
  <div class="content"<?php print $content_attributes; ?>>
       ...
       <div class="md-stepper-horizontal">
            <?php
                ...
                foreach ($tree as $term) {
                  ...
                  if($vocabularioTerm[$content['field_inscriptions_taxonomy'][0]['#title']] >= $numero){ print ' active done';}
                  print '">';
    ...
    <div class="dge-actual-aporta-tabs" id="tabs">
      <ul>
        ...
        <li><a href="#tabs-5" class="bases"><span><?php print t('Challenge terms and conditions'); ?></span></a></li>
        <?php endif;?>
        <?php if ($content['field_inscriptions_content']): ?>
        <li><a href="#tabs-7" class="inscriptions"><span><?php print t('Registration'); ?></span></a></li>
        <?php endif;?>
        <?php if ($content['field_fase_title'] || $content['field_fase']): ?>
        <li><a href="#tabs-1" class="fases"><span><?php print t('Phases'); ?></span></a></li>
        <?php endif;?>
        ...
        <?php endif;?>
        <?php if ($content['field_evaluation_fases']): ?>
        ...
        <?php if ($content['field_inscriptions_taxonomy'][0]['#title'] === 'Seleccionados' || $content['field_inscriptions_taxonomy'][0]['#title'] === 'Premiados'): ?>
          <li <?php if (($content['field_inscriptions_taxonomy'][0]['#title'] === 'Seleccionados' && $urlVar != 5)): ?>
      ...
      <?php if ($content['field_bases_content'] || $content['field_bases_title']): ?>
      <div id="tabs-5">
      <?php if ($content['field_bases_title']): ?>
        <div class="titleBases">
          <?php
          print $content['field_bases_title'][0]['#markup'];
          ?>
        </div>
        <?php endif;?>
        <div class="bases">
      ...
      <?php endif;?>
      <?php if ($content['field_inscriptions_content'] || $content['field_inscriptions_title']): ?>
      <div id="tabs-7">
      <?php if ($content['field_inscriptions_title']): ?>
        <div class="titleInscription">
          <?php
          print $content['field_inscriptions_title'][0]['#markup'];
          ?>
        </div>
        <?php endif;?>
      ...
      <?php if ($content['field_fase_title'] || $content['field_fase']): ?>
      <div id="tabs-1">
      <?php if ($content['field_fase_title']): ?>
        <div class="titleFase">
          <?php
      ...
      <?php if ($content['field_evaluation_fases']): ?>
      <div id="tabs-2">
      <?php if ($content['field_evaluation_title']): ?>
      ...
      <?php if ($content['field_inscriptions_taxonomy'][0]['#title'] === 'Seleccionados' || $content['field_inscriptions_taxonomy'][0]['#title'] === 'Premiados'): ?>
        <div id="tabs-4">
        <?php if ($content['field_selected_title']): ?>
        <div class="titleSelected">
          <?php
          print $content['field_selected_title'][0]['#markup'];
          ?>
        </div>
      <?php endif;?>
          ...
          <div class="selectedSeleccionados">
            ...
            <div class="selectedIdea <?php print ($content['field_selected_image'][0]['#item']['uri'])?'ideas-with-image':'ideas-without-image'; ?>">
            <?php if($content['field_selected_image'][0]['#item']['uri']):?>
                <img alt="<?php print t("Logo seleccionados") ?>" class="<?php if($content['field_image_position'][0]['#markup']==='Izquierda'){print 'izquierdaImagen';}else{print 'derechaImagen';} ?>" src="<?php print file_create_url($content['field_selected_image'][0]['#item']['uri'])?>">
              <?php endif;?>
      ...
      <?php if ($content['field_inscriptions_taxonomy'][0]['#title'] === 'Premiados'): ?>
        <div id="tabs-6">
        <?php if ($content['field_winners_title_principal']): ?>
        <div class="titlePremiados">
          <?php
          print $content['field_winners_title_principal'][0]['#markup'];
          ?>
        </div>
        <?php endif;?>
          <div class="dge-box-left">
            <div  class="descriptionWinners">
              <?php print render($content['field_winners_description']);?>
            </div>
          </div>
          <div class="dge-box-right">
            <?php if($content['field_winners_video']['#items'][0]['value']):?>
              <div class="videoWinners">
                <iframe allowfullscreen="" height="500" style="border: 0;" src="<?php
                $urlYoutube = explode("t=",$content['field_winners_video']['#items'][0]['value']);
                ...
                $variable= str_replace("youtube.com/watch?v=","youtube.com/embed/",$content['field_winners_video']['#items'][0]['value']);
              ...
              ?>?rel=0&amp;showinfo=0&amp;start=<?php echo $segundosFinales?>"></iframe>
               <div class="videoWinnercsSubtitle">
                  <?php print render($content['field_video_subtitle']);?>
                </div>
              </div>
            <?php endif;?>
          </div>
          <div class="winnersParagraph">
            <?php print render($content['field_winners_content']);?>
          </div>
          <div class="finalistParagraph">
            <?php print render($content['field_finalist_content']);?>
          </div>
	   <?php if ($content['field_winners_title_meeting']): ?>
          <div class="meetingWinnersTitle">
            <?php print render($content['field_winners_title_meeting']);?>
          </div>
	  <?php endif;?>
	   <?php if ($content['field_winners_meeting']): ?>
          <div class="meetingWinnersContent">
            <?php print render($content['field_winners_meeting']);?>
          </div>
	<?php endif;?>
        </div>
      <?php endif;?>
