...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="content"<?php print $content_attributes; ?>>
	  <div class="winnerParagraph">
	    <div class="dge-box-left">
        <div class="dge-title-winner">
          <div class="titleWA"><?php  print render ($content['field_winners_title']);?></div>
          <div class="subtitleWA"><?php print render ($content['field_winners_subtitle']);?></div>
        </div>
        ...
        ?>
			  <div class="REDESSOCIALESVISITASCOMPARTIR">
          <div class="redesWinnersParagraph">
					  <div class="redesWinnerParagraphLine"><!-- redes sociales-->
        ...
        </div><!--termina redessocialesvisitascompartir-->
      </div>
